...
# Unit tests for OpenapiClient::WordTimestamp
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::WordTimestamp do
  let(:instance) { OpenapiClient::WordTimestamp.new }

  describe 'test an instance of WordTimestamp' do
    it 'should create an instance of WordTimestamp' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::WordTimestamp)
    end
  end
