...
# Unit tests for OpenapiClient::OAuthUrlCreate
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::OAuthUrlCreate do
  let(:instance) { OpenapiClient::OAuthUrlCreate.new }

  describe 'test an instance of OAuthUrlCreate' do
    it 'should create an instance of OAuthUrlCreate' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::OAuthUrlCreate)
    end
  end
