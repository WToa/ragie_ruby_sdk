...
# Unit tests for OpenapiClient::BodyCreateDocument
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::BodyCreateDocument do
  let(:instance) { OpenapiClient::BodyCreateDocument.new }

  describe 'test an instance of BodyCreateDocument' do
    it 'should create an instance of BodyCreateDocument' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::BodyCreateDocument)
    end
  end
