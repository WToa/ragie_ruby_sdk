...
# Unit tests for OpenapiClient::SetConnectionEnabledPayload
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::SetConnectionEnabledPayload do
  let(:instance) { OpenapiClient::SetConnectionEnabledPayload.new }
  ...
  describe 'test an instance of SetConnectionEnabledPayload' do
    it 'should create an instance of SetConnectionEnabledPayload' do
      ...
      #expect(instance).to be_instance_of(OpenapiClient::SetConnectionEnabledPayload)
    end
  end
