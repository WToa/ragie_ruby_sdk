...
# Unit tests for OpenapiClient::PublicS3CompatibleConnection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PublicS3CompatibleConnection do
  let(:instance) { OpenapiClient::PublicS3CompatibleConnection.new }
  ...
  describe 'test an instance of PublicS3CompatibleConnection' do
    it 'should create an instance of PublicS3CompatibleConnection' do
      ...
      #expect(instance).to be_instance_of(OpenapiClient::PublicS3CompatibleConnection)
    end
  end
