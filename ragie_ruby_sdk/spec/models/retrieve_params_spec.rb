...
# Unit tests for OpenapiClient::RetrieveParams
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::RetrieveParams do
  let(:instance) { OpenapiClient::RetrieveParams.new }

  describe 'test an instance of RetrieveParams' do
    it 'should create an instance of RetrieveParams' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::RetrieveParams)
    end
  end
