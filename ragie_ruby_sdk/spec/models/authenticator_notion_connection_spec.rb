...
# Unit tests for OpenapiClient::AuthenticatorNotionConnection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AuthenticatorNotionConnection do
  let(:instance) { OpenapiClient::AuthenticatorNotionConnection.new }
  ...
  describe 'test an instance of AuthenticatorNotionConnection' do
    it 'should create an instance of AuthenticatorNotionConnection' do
      ...
      #expect(instance).to be_instance_of(OpenapiClient::AuthenticatorNotionConnection)
    end
  end
