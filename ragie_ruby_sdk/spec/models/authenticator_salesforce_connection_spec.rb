...
# Unit tests for OpenapiClient::AuthenticatorSalesforceConnection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::AuthenticatorSalesforceConnection do
  let(:instance) { OpenapiClient::AuthenticatorSalesforceConnection.new }
  ...
  describe 'test an instance of AuthenticatorSalesforceConnection' do
    it 'should create an instance of AuthenticatorSalesforceConnection' do
      ...
      #expect(instance).to be_instance_of(OpenapiClient::AuthenticatorSalesforceConnection)
    end
  end
