...
# Unit tests for OpenapiClient::HubspotData
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::HubspotData do
  let(:instance) { OpenapiClient::HubspotData.new }

  describe 'test an instance of HubspotData' do
    it 'should create an instance of HubspotData' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::HubspotData)
    end
  end
