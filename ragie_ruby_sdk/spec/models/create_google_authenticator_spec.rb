...
# Unit tests for OpenapiClient::CreateGoogleAuthenticator
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::CreateGoogleAuthenticator do
  let(:instance) { OpenapiClient::CreateGoogleAuthenticator.new }
  ...
  describe 'test an instance of CreateGoogleAuthenticator' do
    it 'should create an instance of CreateGoogleAuthenticator' do
      ...
      #expect(instance).to be_instance_of(OpenapiClient::CreateGoogleAuthenticator)
    end
  end
