...
# Unit tests for OpenapiClient::PublicGCSConnection
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::PublicGCSConnection do
  let(:instance) { OpenapiClient::PublicGCSConnection.new }

  describe 'test an instance of PublicGCSConnection' do
    it 'should create an instance of PublicGCSConnection' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::PublicGCSConnection)
    end
  end
