...
# Unit tests for OpenapiClient::Instruction
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::Instruction do
  let(:instance) { OpenapiClient::Instruction.new }

  describe 'test an instance of Instruction' do
    it 'should create an instance of Instruction' do
      # uncomment below to test the instance creation
      #expect(instance).to be_instance_of(OpenapiClient::Instruction)
    end
  end
