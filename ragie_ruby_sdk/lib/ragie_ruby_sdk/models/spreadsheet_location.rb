  ...
  class SpreadsheetLocation < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RagieRubySdk::SpreadsheetLocation` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RagieRubySdk::SpreadsheetLocation`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'location_type')
        ...
        self.location_type = 'spreadsheet'
      end
      ...
      if attributes.key?(:'sheet_index')
        self.sheet_index = attributes[:'sheet_index']
      end
    end
    ...
    def valid?
      ...
      location_type_validator = EnumAttributeValidator.new('String', ["spreadsheet"])
    ...
    def location_type=(location_type)
      validator = EnumAttributeValidator.new('String', ["spreadsheet"])
    ...
    def hash
      [location_type, range, sheet_name, sheet_index].hash
    end
