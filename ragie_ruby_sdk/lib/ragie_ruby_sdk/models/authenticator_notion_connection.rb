...
module RagieRubySdk
  class AuthenticatorNotionConnection < ApiModelBase
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RagieRubySdk::AuthenticatorNotionConnection` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!acceptable_attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RagieRubySdk::AuthenticatorNotionConnection`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      ...
      provider_validator = EnumAttributeValidator.new('String', ["notion"])
    ...
    def provider=(provider)
      validator = EnumAttributeValidator.new('String', ["notion"])
    ...
    # Custom attribute writer method with validation
    # @param [Object] workspace_name Value to be assigned
    def workspace_name=(workspace_name)
      if workspace_name.nil?
        fail ArgumentError, 'workspace_name cannot be nil'
      end
    ...
    def hash
      [provider, workspace_id, workspace_name, user_email, credentials].hash
    end
