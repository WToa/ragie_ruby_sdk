...
module RagieRubySdk
  class ConnectionSyncProgressWebhookPayload < ApiModelBase
    ...
    attr_accessor :paused_insufficient_credits_count
    ...
    def self.attribute_map
      {
        ...
        :'paused_insufficient_credits_count' => :'paused_insufficient_credits_count'
      }
    end
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'paused_insufficient_credits_count')
        self.paused_insufficient_credits_count = attributes[:'paused_insufficient_credits_count']
      else
        self.paused_insufficient_credits_count = nil
      end
    end
    ...
    def list_invalid_properties
      ...
      if @paused_insufficient_credits_count.nil?
        invalid_properties.push('invalid value for "paused_insufficient_credits_count", paused_insufficient_credits_count cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @paused_insufficient_credits_count.nil?
      true
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] paused_insufficient_credits_count Value to be assigned
    def paused_insufficient_credits_count=(paused_insufficient_credits_count)
      if paused_insufficient_credits_count.nil?
        fail ArgumentError, 'paused_insufficient_credits_count cannot be nil'
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          paused_insufficient_credits_count == o.paused_insufficient_credits_count
    end
    ...
    def hash
      [connection_id, sync_id, partition, connection_metadata, create_count, created_count, update_content_count, updated_content_count, update_metadata_count, updated_metadata_count, delete_count, deleted_count, errored_count, paused_insufficient_credits_count].hash
    end
