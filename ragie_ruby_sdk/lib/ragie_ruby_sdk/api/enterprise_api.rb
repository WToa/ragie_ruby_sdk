  ...
  class EnterpriseApi
    ...
    def create_authenticator_with_http_info(payload, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EnterpriseApi.create_authenticator ...'
      end
      # verify the required parameter 'payload' is set
      if @api_client.config.client_side_validation && payload.nil?
        fail ArgumentError, "Missing the required parameter 'payload' when calling EnterpriseApi.create_authenticator"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"EnterpriseApi.create_authenticator",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EnterpriseApi#create_authenticator\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def create_authenticator_connection_with_http_info(authenticator_id, create_authenticator_connection, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EnterpriseApi.create_authenticator_connection ...'
      end
      # verify the required parameter 'authenticator_id' is set
      if @api_client.config.client_side_validation && authenticator_id.nil?
        fail ArgumentError, "Missing the required parameter 'authenticator_id' when calling EnterpriseApi.create_authenticator_connection"
      end
      ...
      if @api_client.config.client_side_validation && create_authenticator_connection.nil?
        fail ArgumentError, "Missing the required parameter 'create_authenticator_connection' when calling EnterpriseApi.create_authenticator_connection"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"EnterpriseApi.create_authenticator_connection",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EnterpriseApi#create_authenticator_connection\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def create_connection_with_http_info(public_create_connection, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EnterpriseApi.create_connection ...'
      end
      ...
      if @api_client.config.client_side_validation && public_create_connection.nil?
        fail ArgumentError, "Missing the required parameter 'public_create_connection' when calling EnterpriseApi.create_connection"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"EnterpriseApi.create_connection",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EnterpriseApi#create_connection\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def delete_authenticator_connection_with_http_info(authenticator_id, opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EnterpriseApi.delete_authenticator_connection ...'
      end
      # verify the required parameter 'authenticator_id' is set
      if @api_client.config.client_side_validation && authenticator_id.nil?
        fail ArgumentError, "Missing the required parameter 'authenticator_id' when calling EnterpriseApi.delete_authenticator_connection"
      end
      # resource path
      ...
      new_options = opts.merge(
        :operation => :"EnterpriseApi.delete_authenticator_connection",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EnterpriseApi#delete_authenticator_connection\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def list_authenticators_with_http_info(opts = {})
      if @api_client.config.debugging
        @api_client.config.logger.debug 'Calling API: EnterpriseApi.list_authenticators ...'
      end
      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] > 100
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling EnterpriseApi.list_authenticators, must be smaller than or equal to 100.'
      end

      if @api_client.config.client_side_validation && !opts[:'page_size'].nil? && opts[:'page_size'] < 1
        fail ArgumentError, 'invalid value for "opts[:"page_size"]" when calling EnterpriseApi.list_authenticators, must be greater than or equal to 1.'
      end
      ...
      new_options = opts.merge(
        :operation => :"EnterpriseApi.list_authenticators",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: EnterpriseApi#list_authenticators\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
  end
