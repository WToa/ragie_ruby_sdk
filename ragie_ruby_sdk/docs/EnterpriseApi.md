# OpenapiClient::EnterpriseApi

All URIs are relative to *https://api.ragie.ai*

| Method | HTTP request | Description |
| ------ | ------------ | ----------- |
| [**create_authenticator**](EnterpriseApi.md#create_authenticator) | **POST** /authenticators | Create Authenticator |
| [**create_authenticator_connection**](EnterpriseApi.md#create_authenticator_connection) | **POST** /authenticators/{authenticator_id}/connection | Create Authenticator Connection |
| [**create_connection**](EnterpriseApi.md#create_connection) | **POST** /connection | Create Connection |
| [**delete_authenticator_connection**](EnterpriseApi.md#delete_authenticator_connection) | **DELETE** /authenticators/{authenticator_id} | Delete Authenticator |
| [**list_authenticators**](EnterpriseApi.md#list_authenticators) | **GET** /authenticators | List Authenticators |
...
api_instance = OpenapiClient::EnterpriseApi.new
...
begin
  ...
  puts "Error when calling EnterpriseApi->create_authenticator: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EnterpriseApi->create_authenticator_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EnterpriseApi->create_authenticator_connection: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EnterpriseApi->create_authenticator_connection_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EnterpriseApi->create_connection: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EnterpriseApi->create_connection_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EnterpriseApi->delete_authenticator_connection: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EnterpriseApi->delete_authenticator_connection_with_http_info: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EnterpriseApi->list_authenticators: #{e}"
end
```
...
begin
  ...
  puts "Error when calling EnterpriseApi->list_authenticators_with_http_info: #{e}"
end
```
