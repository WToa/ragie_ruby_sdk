...
```shell
gem install ./ragie_ruby_sdk-1.0.45.gem
```

(for development, run `gem install --dev ./ragie_ruby_sdk-1.0.45.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'ragie_ruby_sdk', '~> 1.0.45'
...
*RagieRubySdk::ElementsApi* | [**get_element**](docs/ElementsApi.md#get_element) | **GET** /elements/{element_id} | Get Element For Document
*RagieRubySdk::ElementsApi* | [**list_elements**](docs/ElementsApi.md#list_elements) | **GET** /documents/{document_id}/elements | List Elements For Document
...
*RagieRubySdk::EntitiesApi* | [**list_instruction_entity_extraction_logs**](docs/EntitiesApi.md#list_instruction_entity_extraction_logs) | **GET** /instructions/{instruction_id}/entity-extraction-logs | Get Instruction Entity Extraction Logs
*RagieRubySdk::EntitiesApi* | [**list_instructions**](docs/EntitiesApi.md#list_instructions) | **GET** /instructions | List Instructions
*RagieRubySdk::EntitiesApi* | [**patch_instruction**](docs/EntitiesApi.md#patch_instruction) | **PATCH** /instructions/{instruction_id} | Patch Instruction
...
*RagieRubySdk::WebhookEndpointsApi* | [**create_webhook_endpoint**](docs/WebhookEndpointsApi.md#create_webhook_endpoint) | **POST** /webhook_endpoints | Create Webhook Endpoint
*RagieRubySdk::WebhookEndpointsApi* | [**delete_webhook_endpoint**](docs/WebhookEndpointsApi.md#delete_webhook_endpoint) | **DELETE** /webhook_endpoints/{endpoint_id} | Delete Webhook Endpoint
*RagieRubySdk::WebhookEndpointsApi* | [**get_webhook_endpoint**](docs/WebhookEndpointsApi.md#get_webhook_endpoint) | **GET** /webhook_endpoints/{endpoint_id} | Get Webhook Endpoint
*RagieRubySdk::WebhookEndpointsApi* | [**list_webhook_endpoints**](docs/WebhookEndpointsApi.md#list_webhook_endpoints) | **GET** /webhook_endpoints | List Webhook Endpoints
*RagieRubySdk::WebhookEndpointsApi* | [**update_webhook_endpoint**](docs/WebhookEndpointsApi.md#update_webhook_endpoint) | **PATCH** /webhook_endpoints/{endpoint_id} | Update Webhook Endpoint


## Documentation for Models

 - [RagieRubySdk::AccessTokenCredentials](docs/AccessTokenCredentials.md)
 - [RagieRubySdk::Address](docs/Address.md)
 ...
 - [RagieRubySdk::ApiDocumentElement](docs/ApiDocumentElement.md)
 - [RagieRubySdk::ApiDocumentElementLocation](docs/ApiDocumentElementLocation.md)
 - [RagieRubySdk::ApiElement](docs/ApiElement.md)
 ...
 - [RagieRubySdk::AudioTranscriptionSegment](docs/AudioTranscriptionSegment.md)
 ...
 - [RagieRubySdk::BoundingBoxLocation](docs/BoundingBoxLocation.md)
 - [RagieRubySdk::BucketData](docs/BucketData.md)
 - [RagieRubySdk::Button](docs/Button.md)
 - [RagieRubySdk::CalendarDate](docs/CalendarDate.md)
 - [RagieRubySdk::Caption](docs/Caption.md)
 - [RagieRubySdk::CharacterIndexLocation](docs/CharacterIndexLocation.md)
 - [RagieRubySdk::Code](docs/Code.md)
 ...
 - [RagieRubySdk::Comment](docs/Comment.md)
 ...
 - [RagieRubySdk::CreatePartitionParamsMetadataSchemaValue](docs/CreatePartitionParamsMetadataSchemaValue.md)
 - [RagieRubySdk::CreateWebhookEndpointPayload](docs/CreateWebhookEndpointPayload.md)
 - [RagieRubySdk::Data](docs/Data.md)
 - [RagieRubySdk::DefinitionList](docs/DefinitionList.md)
 ...
 - [RagieRubySdk::DocumentElementType](docs/DocumentElementType.md)
 ...
 - [RagieRubySdk::DocumentWorkflow](docs/DocumentWorkflow.md)
 - [RagieRubySdk::DurationLocation](docs/DurationLocation.md)
 - [RagieRubySdk::EmailAddress](docs/EmailAddress.md)
 ...
 - [RagieRubySdk::EvidenceInner](docs/EvidenceInner.md)
 - [RagieRubySdk::FailedStep](docs/FailedStep.md)
 - [RagieRubySdk::Figure](docs/Figure.md)
 - [RagieRubySdk::FigureCaption](docs/FigureCaption.md)
 ...
 - [RagieRubySdk::Footer](docs/Footer.md)
 - [RagieRubySdk::Footnote](docs/Footnote.md)
 - [RagieRubySdk::FormField](docs/FormField.md)
 - [RagieRubySdk::FormOption](docs/FormOption.md)
 - [RagieRubySdk::Formula](docs/Formula.md)
 ...
 - [RagieRubySdk::Header](docs/Header.md)
 - [RagieRubySdk::HubspotData](docs/HubspotData.md)
 - [RagieRubySdk::Image](docs/Image.md)
 - [RagieRubySdk::InputTokenDetails](docs/InputTokenDetails.md)
 - [RagieRubySdk::Instruction](docs/Instruction.md)
 - [RagieRubySdk::InstructionEntityExtractionLog](docs/InstructionEntityExtractionLog.md)
 - [RagieRubySdk::InstructionEntityExtractionLogList](docs/InstructionEntityExtractionLogList.md)
 - [RagieRubySdk::IntercomCredentials](docs/IntercomCredentials.md)
 - [RagieRubySdk::IntercomData](docs/IntercomData.md)
 - [RagieRubySdk::Json](docs/Json.md)
 - [RagieRubySdk::KeyValue](docs/KeyValue.md)
 - [RagieRubySdk::Link](docs/Link.md)
 - [RagieRubySdk::ListConnectorSourceTypeInfo](docs/ListConnectorSourceTypeInfo.md)
 - [RagieRubySdk::ListDocumentElements](docs/ListDocumentElements.md)
 - [RagieRubySdk::ListItem](docs/ListItem.md)
 - [RagieRubySdk::LocationInner](docs/LocationInner.md)
 - [RagieRubySdk::Logo](docs/Logo.md)
 ...
 - [RagieRubySdk::NarrativeText](docs/NarrativeText.md)
 ...
 - [RagieRubySdk::OrderedList](docs/OrderedList.md)
 - [RagieRubySdk::OutputInner](docs/OutputInner.md)
 - [RagieRubySdk::OutputTokenDetails](docs/OutputTokenDetails.md)
 - [RagieRubySdk::PageBreak](docs/PageBreak.md)
 ...
 - [RagieRubySdk::PatchInstructionParams](docs/PatchInstructionParams.md)
 ...
 - [RagieRubySdk::PublicWebcrawlerConnection](docs/PublicWebcrawlerConnection.md)
 - [RagieRubySdk::PublicZendeskConnection](docs/PublicZendeskConnection.md)
 - [RagieRubySdk::QRCode](docs/QRCode.md)
 - [RagieRubySdk::QueryDetails](docs/QueryDetails.md)
 - [RagieRubySdk::Quote](docs/Quote.md)
 ...
 - [RagieRubySdk::SectionHeader](docs/SectionHeader.md)
 ...
 - [RagieRubySdk::Signature](docs/Signature.md)
 - [RagieRubySdk::SlackData](docs/SlackData.md)
 - [RagieRubySdk::Source](docs/Source.md)
 - [RagieRubySdk::SpreadsheetLocation](docs/SpreadsheetLocation.md)
 - [RagieRubySdk::Stamp](docs/Stamp.md)
 - [RagieRubySdk::StepsInner](docs/StepsInner.md)
 - [RagieRubySdk::SubHeader](docs/SubHeader.md)
 - [RagieRubySdk::SurrenderStep](docs/SurrenderStep.md)
 - [RagieRubySdk::Table](docs/Table.md)
 - [RagieRubySdk::TableOfContents](docs/TableOfContents.md)
 - [RagieRubySdk::Text](docs/Text.md)
 - [RagieRubySdk::Time](docs/Time.md)
 - [RagieRubySdk::Title](docs/Title.md)
 - [RagieRubySdk::Tool](docs/Tool.md)
 - [RagieRubySdk::UncategorizedText](docs/UncategorizedText.md)
 - [RagieRubySdk::UnorderedList](docs/UnorderedList.md)
 ...
 - [RagieRubySdk::UpdateWebhookEndpointPayload](docs/UpdateWebhookEndpointPayload.md)
 - [RagieRubySdk::ValidationError](docs/ValidationError.md)
 - [RagieRubySdk::Video](docs/Video.md)
 - [RagieRubySdk::VideoModalityData](docs/VideoModalityData.md)
 - [RagieRubySdk::VideoSegment](docs/VideoSegment.md)
 - [RagieRubySdk::Watermark](docs/Watermark.md)
 - [RagieRubySdk::WebcrawlerData](docs/WebcrawlerData.md)
 - [RagieRubySdk::WebhookEndpoint](docs/WebhookEndpoint.md)
 - [RagieRubySdk::WebhookEndpointList](docs/WebhookEndpointList.md)
 - [RagieRubySdk::WordModality](docs/WordModality.md)
